...
- Cloud-based image uploads (AWS S3)
...
**MERN Stack | Next.js | Angular | Java | Spring Boot | TypeScript | System Design**

---

### 💬 Ask me about
**Backend Development | REST APIs | Real-time Apps | React | Node.js | Redis | Cloud Integration**
